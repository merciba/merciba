    ...
    getLanding() {
      if (this.props.route === "/") {
        return <article className="container logo-container" ref="logo">
          {window.isMobile() ? null : <video id="video-logo" style={this.state.videoLogo} muted autoplay="autoplay" src="https://s3.amazonaws.com/merciba.com/assets/merciba-animation.mov" type="video/quicktime"></video>}
